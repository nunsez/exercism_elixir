defmodule CaptainsLogTest do
  ...
  describe "format_stardate" do
    ...
    test "returns a string" do
      assert is_bitstring(CaptainsLog.format_stardate(41_010.7))
    end

    @tag task_id: 4
    test "formats floats" do
      assert CaptainsLog.format_stardate(41_543.3) == "41543.3"
    end

    @tag task_id: 4
    test "rounds floats to one decimal place" do
      assert CaptainsLog.format_stardate(41_032.4512) == "41032.5"
    end

    @tag task_id: 4
    test "does not accept integers" do
      assert_raise ArgumentError, fn -> CaptainsLog.format_stardate(41_411) end
    end
  end
end
